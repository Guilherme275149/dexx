...
const botfeio = 'É Você Feio Pra Porra, Quando Você Nasceu Os Médicos Mando Volta Porque Você Não Estava Pronto Ainda'
const cadebot = 'Me chamou onii-chan 👉👈?'
const botfdp = 'Sua Mãe Aquela Arromabada'
const botgostoso = 'Vamo Fazer Sekisu 😳👉👈'
const botfofo = 'Ownt Bigaduh😳👉👈'
const botbaianor = 'Convidei Sua Mãe Pra Minha Rede😳'
const botcorno = 'Corni É Seu Pai Aquele Assumido'
const botputa = 'Puta É Sua Mãe😳'
const botgay = 'Ontem Sua Mãe Deu Várias Sentada Em Meu Opan'
const botviado = 'Eu Não Tu Que Deixa'
const numbotfeio = 'Fala Assim Não Maguo😔'
// KEYS

// MENSAGENS DE EXCLUSIVIDADE
let mess = {
    wait: 'Calma Ae lek Enquanto Isso Pega Uma Xícara De Café Pará Toma',
    success: '✔️ Sucesso! ✔️',
    error: {
